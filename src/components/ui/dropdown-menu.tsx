  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        class={cn(
          "animate-content-hide border-border bg-popover text-popover-foreground data-[expanded]:animate-content-show z-50 min-w-32 origin-[var(--kb-menu-content-transform-origin)] overflow-hidden rounded-md border p-1 shadow-md",
          props.class
        )}
        {...rest}
      />
...
const DropdownMenuSeparator = <T extends ValidComponent = "hr">(
  ...
  return (
    <DropdownMenuPrimitive.Separator
      class={cn("bg-muted text-muted -mx-1 my-1 h-px", props.class)}
      {...rest}
    />
  );
};
